...
public class VehicleInsuranceAppTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			WebElement vehicleNumber = driver.findElement(By.xpath("//android.widget.EditText[@hint='Enter Vehicle Number']"));
			if(vehicleNumber.isDisplayed()) {
				System.out.println("Successfully navigated to submitclaim page");
			}
			vehicleNumber.sendKeys("2510");
			WebElement details = driver.findElement(By.xpath("//android.widget.EditText[@hint='Enter claim description']"));
			...
			ClaimId.sendKeys("1");
			WebElement claimStatus = driver.findElement(By.xpath("//android.widget.EditText[@hint='Enter New Status']"));
